...
* Fixed: Deactivating the plugin left one scheduled task behind. It did nothing and was dropped the moment it fired, but it stayed in your database until the plugin was installed again.
