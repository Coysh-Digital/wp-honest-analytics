 ...
 *
 * A package without the consented tier is cookieless: no cookie to read, no log
 * to write, no endpoint to record a decision. Answering null here is not a
 * refusal being simulated - it is the true answer for a build where the question
 * cannot be asked.
 *
 * Everything else about a hit is unchanged. The visitor hash every build uses
 * comes from Identity, is derived from a salt that rotates every twenty-four
 * hours, and has nothing to do with this.
 */
